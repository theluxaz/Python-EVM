...
# import pickledb
# db = pickledb.load('EVM_STATE.db', True)
...
#DATA
# EVM_STATE ={
#                 "95222290DD7278Aa3Ddd389Cc1E1d165C04BA000":{"bytecode":"604260005260206000F3","balance":1000000000000000000,"state":""},         
#                 "95222290DD7278Aa3Ddd389Cc1E1d165C04BA021":{"bytecode":"60426000526020600060046000600038","balance":2000000000000000000,"state":""},
#                 "1e79b045dc29eae9fdc69673c9dcd7c53e5e159d":{"bytecode":"","balance":256,"state":""},#test case
#                 "1000000000000000000000000000000000000aaa":{"bytecode":"6001","balance":9,"state":""},#test case
#                 "1000000000000000000000000000000000000aab":{"bytecode":"FFFFFFFF","balance":0,"state":""},#test case
#                 "1000000000000000000000000000000000000c42":{"bytecode":"60426000526001601ff3","balance":0,"state":""},#test case CALL 1
#                 "1000000000000000000000000000000000000c43":{"bytecode":"3360005260206000f3","balance":0,"state":""},#test case CALL 2
#                 "1000000000000000000000000000000000000c44":{"bytecode":"60426000526001601ffd","balance":0,"state":""},#test case CALL 3
#                 "dddddddddddddddddddddddddddddddddddddddd":{"bytecode":"30600055","balance":0,"state":""},#test case DELEGATE CALL 1
#                 "1000000000000000000000000000000000000c4d":{"bytecode":"30600055","balance":0,"state":""},#test case STATIC CALL 2
#                 "dead00000000000000000000000000000000dead":{"bytecode":"731000000000000000000000000000000000000aaaff","balance":7,"state":""},#test case SELF DESTRUCT 1
#                 "95222290DD7278Aa3Ddd389Cc1E1d165C04B1111":{"bytecode":"","balance":2000000000000000000,"state":""}
#                 }

# for key,value in EVM_STATE.items():
#     db.set(key,value)
...
def start(bytecode: bytearray, execution_context_data:dict,transaction_context_data:dict):
    contract_instance_main = ContractInstance(ExecutionContext(*execution_context_data.values()),TransactionContext(*transaction_context_data.values()),State(False))
...
def main() -> None:
    ...
    if(type(result) == str):
        print(f"FINAL result is : str {result.hex()}")
    else:
        print(f"FINAL result is :  {result}")
       
       
def start_testing(bytecode: bytearray, execution_context_data:dict,transaction_context_data:dict):
    contract_instance_main = ContractInstance(ExecutionContext(*execution_context_data.values()),TransactionContext(*transaction_context_data.values()),State(True))
...
def process_EVM_STATE(EVM_STATE:dict):
    EVM_STATE_list =[]
    for key,value in EVM_STATE.items():
            EVM_STATE_list.append(ExternalContract(key.to_bytes(20, byteorder = 'big'), bytearray.fromhex(value)))

    return EVM_STATE_list
