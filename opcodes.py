...
class Opcodes:
    ...
    #OPCODE     GAS
    #01         3  
    def ADD(self,executor:object) -> int:
        #(a:int, b:int)
        a = executor.stack.pop()
        b = executor.stack.pop()
        return a+b

    #OPCODE     GAS
    #02         5  
    def MUL(self,executor:object) -> int:
        #(a:int, b:int)
        return a*b

    #OPCODE     GAS
    #03         3  
    def SUB(self,executor:object) -> int:
        #(a:int, b:int)
        return a-b

    #OPCODE     GAS
    #04         2  
    def DIV(self,executor:object) -> int:
        #(a:int, b:int)
        return a/b

    #OPCODE     GAS
    #05         5  
    def SDIV(self,executor:object) -> int:
        #(a:int, b:int)
    ...
    #OPCODE     GAS
    #06         5  
    def MOD(self,executor:object) -> int:
        #(a:int, b:int)
        return a%b

    #OPCODE     GAS
    #07         5  
    def SMOD(self,executor:object) -> int:
        #(a:int, b:int)
        #SIGNED MODULUS
        return a%b
    ...
    #OPCODE     GAS
    #08         8  
    def ADDMOD(self,executor:object) -> int:
        #(a:int, b:int, N:int
    ...
    #OPCODE     GAS
    #09         8  
    def MULMOD(self,executor:object) -> int:
        #(a:int, b:int, N:int
    ...
    #OPCODE     GAS
    #0A         10   dynamic  
    def EXP(self,executor:object) -> int:
        #(a:int, b:int
        #EXPONENT
        return a**b
    ...
    #OPCODE     GAS
    #0B         5  
    def SIGNEXTEND(self,executor:object) -> int:
        #(b:int, x:int
    ...
    #5B         1 
    def JUMPDEST():
        #Mark a valid destination for jump
        return None
    ...
    #OPCODE     GAS
    #60         3   
    def PUSH1(self,executor:object) -> int:
        #Place 1 bytes item on stack
        executor.stack.push(executor.processBytecode(1))
        return None
